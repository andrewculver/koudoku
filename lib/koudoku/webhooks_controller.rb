class Koudoku::WebhooksController
  def process
    
    raise "API key not configured. For security reasons you must configure this in 'config/koudoku.rb'." unless params[:api_key].present?
